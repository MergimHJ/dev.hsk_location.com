<?php 
$isEdit = isset($data['car']) && !empty($data['car']['id']);
?>
...
<form action="/admin/catalog/save" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div>
                ...
                <input type="number"
                    id="year"
                    name="year"
                    value="<?= htmlspecialchars($data['car']['year'] ?? date('Y')) ?>"
                    required
                    min="1900"
                    max="<?= date('Y') + 2 ?>">
            </div>
            ...
            <div style="grid-column: span 2;">
                ...
                <textarea id="description"
                    ...
                    rows="3"
                    maxlength="500"
                    placeholder="Short description for card display"><?= htmlspecialchars($data['car']['description'] ?? '') ?></textarea>
            </div>
            ...
            <div style="grid-column: span 2;">
                ...
                <textarea id="content"
                    name="content"
                    rows="6"
                    placeholder="Detailed description for the car page"><?= htmlspecialchars($data['car']['content'] ?? '') ?></textarea>
            </div>
        </div>
    </fieldset>
        ...
        <div>
            ...
            <div>
                ...
                <input type="number"
                    id="brand_id"
                    name="brand_id"
                    value="<?= htmlspecialchars($data['car']['brand_id'] ?? '1') ?>"
                    required
                    min="1">
            </div>

            <div>
                <label for="category_tag_id">Category *</label>
            ...
            <div>
                <label for="theme_tag_id">Theme *</label>
                <select name="theme_tag_id" required>
                    <option value="">Select Theme</option>
                    <?php foreach ($data['themes'] as $theme): ?>
                        <option value="<?= $theme['id'] ?>" <?= isset($data['car']['theme_tag_id']) && $data['car']['theme_tag_id'] == $theme['id'] ? 'selected' : '' ?>>
            ...
            <div>
                ...
                <input type="text"
                    id="carrosserie"
                    name="carrosserie"
                    value="<?= htmlspecialchars($data['car']['carrosserie'] ?? 'Coupé') ?>"
                    maxlength="50"
                    placeholder="e.g. Coupé, SUV, Berline">
            </div>
        </div>
    </fieldset>
        ...
        <div>
            ...
            <div>
                ...
                <input type="number"
                    id="cylinders"
                    name="cylinders"
                    value="<?= htmlspecialchars($data['car']['cylinders'] ?? '8') ?>"
                    required
                    min="1"
                    max="16">
            </div>
            ...
            <div>
                ...
                <input type="number"
                    ...
                    value="<?= htmlspecialchars($data['car']['wheel-transmission'] ?? '1') ?>"
                    required
                    min="1"
                    max="4">
            </div>
        ...
        <div>
            ...
            <div>
                ...
                <input type="number"
                    id="deposit"
                    name="deposit"
                    value="<?= htmlspecialchars($data['car']['deposit'] ?? '1000') ?>"
                    step="0.01"
                    min="0"
            ...
            <div style="grid-column: span 2;">
                ...
                <?php if ($isEdit && !empty($data['car']['image'])): ?>
                    <div style="margin-top: 10px;">
                        ...
                        <img src="/assets/cars/<?= $data['car']['slug']; ?>/<?= $data['car']['image']; ?>"
    ...
    <fieldset>
        ...
        <div style="display: flex; gap: 15px; align-items: center;">
            ...
            <a href="/admin/catalog" class="btn" style="background: #6c757d; color: white; text-decoration: none;">Cancel</a>
        </div>
    </fieldset>
</form>